...
* [`component-connectivity-implementation-plan.md`](component-connectivity-implementation-plan.md) — milestone tracker. **Nothing started.** Phase 0/1 unblocked; **Phase 2 gated on D4** (base unblocked 2026-09-15 — see §Branch base); Phase 3 spans both client repos.
