...
PROTOBUF_CONSTEXPR EdaDataFile_NetRecord_ToeprintSubnetRecord::EdaDataFile_NetRecord_ToeprintSubnetRecord(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
...
struct EdaDataFile_NetRecord_ToeprintSubnetRecordDefaultTypeInternal {
  PROTOBUF_CONSTEXPR EdaDataFile_NetRecord_ToeprintSubnetRecordDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~EdaDataFile_NetRecord_ToeprintSubnetRecordDefaultTypeInternal() {}
  union {
    EdaDataFile_NetRecord_ToeprintSubnetRecord _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 EdaDataFile_NetRecord_ToeprintSubnetRecordDefaultTypeInternal _EdaDataFile_NetRecord_ToeprintSubnetRecord_default_instance_;
PROTOBUF_CONSTEXPR EdaDataFile_NetRecord_PlaneSubnetRecord::EdaDataFile_NetRecord_PlaneSubnetRecord(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
...
struct EdaDataFile_NetRecord_PlaneSubnetRecordDefaultTypeInternal {
  PROTOBUF_CONSTEXPR EdaDataFile_NetRecord_PlaneSubnetRecordDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~EdaDataFile_NetRecord_PlaneSubnetRecordDefaultTypeInternal() {}
  union {
    EdaDataFile_NetRecord_PlaneSubnetRecord _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 EdaDataFile_NetRecord_PlaneSubnetRecordDefaultTypeInternal _EdaDataFile_NetRecord_PlaneSubnetRecord_default_instance_;
...
static ::_pb::Metadata file_level_metadata_edadatafile_2eproto[12];
...
const uint32_t TableStruct_edadatafile_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  0,
  ~0u,
  PROTOBUF_FIELD_OFFSET(::odbdesign::proto::EdaDataFile_NetRecord_ToeprintSubnetRecord, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::odbdesign::proto::EdaDataFile_NetRecord_ToeprintSubnetRecord, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::odbdesign::proto::EdaDataFile_NetRecord_PlaneSubnetRecord, _impl_.filltype_),
  PROTOBUF_FIELD_OFFSET(::odbdesign::proto::EdaDataFile_NetRecord_PlaneSubnetRecord, _impl_.cutouttype_),
  PROTOBUF_FIELD_OFFSET(::odbdesign::proto::EdaDataFile_NetRecord_PlaneSubnetRecord, _impl_.fillsize_),
  0,
  1,
  2,
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::odbdesign::proto::_EdaDataFile_NetRecord_ToeprintSubnetRecord_default_instance_._instance,
  &::odbdesign::proto::_EdaDataFile_NetRecord_PlaneSubnetRecord_default_instance_._instance,
...
#if (__cplusplus < 201703) && (!defined(_MSC_VER) || (_MSC_VER >= 1900 && _MSC_VER < 1912))
constexpr EdaDataFile_NetRecord_PlaneSubnetRecord_FillType EdaDataFile_NetRecord_PlaneSubnetRecord::SOLID;
constexpr EdaDataFile_NetRecord_PlaneSubnetRecord_FillType EdaDataFile_NetRecord_PlaneSubnetRecord::OUTLINE;
constexpr EdaDataFile_NetRecord_PlaneSubnetRecord_FillType EdaDataFile_NetRecord_PlaneSubnetRecord::FillType_MIN;
constexpr EdaDataFile_NetRecord_PlaneSubnetRecord_FillType EdaDataFile_NetRecord_PlaneSubnetRecord::FillType_MAX;
constexpr int EdaDataFile_NetRecord_PlaneSubnetRecord::FillType_ARRAYSIZE;
#endif  // (__cplusplus < 201703) && (!defined(_MSC_VER) || (_MSC_VER >= 1900 && _MSC_VER < 1912))
...
#if (__cplusplus < 201703) && (!defined(_MSC_VER) || (_MSC_VER >= 1900 && _MSC_VER < 1912))
constexpr EdaDataFile_NetRecord_PlaneSubnetRecord_CutoutType EdaDataFile_NetRecord_PlaneSubnetRecord::CIRCLE;
constexpr EdaDataFile_NetRecord_PlaneSubnetRecord_CutoutType EdaDataFile_NetRecord_PlaneSubnetRecord::RECTANGLE;
constexpr EdaDataFile_NetRecord_PlaneSubnetRecord_CutoutType EdaDataFile_NetRecord_PlaneSubnetRecord::OCTAGON;
constexpr EdaDataFile_NetRecord_PlaneSubnetRecord_CutoutType EdaDataFile_NetRecord_PlaneSubnetRecord::EXACT;
constexpr EdaDataFile_NetRecord_PlaneSubnetRecord_CutoutType EdaDataFile_NetRecord_PlaneSubnetRecord::CutoutType_MIN;
constexpr EdaDataFile_NetRecord_PlaneSubnetRecord_CutoutType EdaDataFile_NetRecord_PlaneSubnetRecord::CutoutType_MAX;
constexpr int EdaDataFile_NetRecord_PlaneSubnetRecord::CutoutType_ARRAYSIZE;
#endif  // (__cplusplus < 201703) && (!defined(_MSC_VER) || (_MSC_VER >= 1900 && _MSC_VER < 1912))
...
EdaDataFile_NetRecord_ToeprintSubnetRecord::EdaDataFile_NetRecord_ToeprintSubnetRecord(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:odbdesign.proto.EdaDataFile.NetRecord.ToeprintSubnetRecord)
}
EdaDataFile_NetRecord_ToeprintSubnetRecord::EdaDataFile_NetRecord_ToeprintSubnetRecord(const EdaDataFile_NetRecord_ToeprintSubnetRecord& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  EdaDataFile_NetRecord_ToeprintSubnetRecord* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
inline void EdaDataFile_NetRecord_ToeprintSubnetRecord::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
EdaDataFile_NetRecord_ToeprintSubnetRecord::~EdaDataFile_NetRecord_ToeprintSubnetRecord() {
  // @@protoc_insertion_point(destructor:odbdesign.proto.EdaDataFile.NetRecord.ToeprintSubnetRecord)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void EdaDataFile_NetRecord_ToeprintSubnetRecord::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void EdaDataFile_NetRecord_ToeprintSubnetRecord::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void EdaDataFile_NetRecord_ToeprintSubnetRecord::Clear() {
// @@protoc_insertion_point(message_clear_start:odbdesign.proto.EdaDataFile.NetRecord.ToeprintSubnetRecord)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* EdaDataFile_NetRecord_ToeprintSubnetRecord::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
...
uint8_t* EdaDataFile_NetRecord_ToeprintSubnetRecord::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:odbdesign.proto.EdaDataFile.NetRecord.ToeprintSubnetRecord)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:odbdesign.proto.EdaDataFile.NetRecord.ToeprintSubnetRecord)
  return target;
}

size_t EdaDataFile_NetRecord_ToeprintSubnetRecord::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:odbdesign.proto.EdaDataFile.NetRecord.ToeprintSubnetRecord)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData EdaDataFile_NetRecord_ToeprintSubnetRecord::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    EdaDataFile_NetRecord_ToeprintSubnetRecord::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*EdaDataFile_NetRecord_ToeprintSubnetRecord::GetClassData() const { return &_class_data_; }


void EdaDataFile_NetRecord_ToeprintSubnetRecord::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<EdaDataFile_NetRecord_ToeprintSubnetRecord*>(&to_msg);
  auto& from = static_cast<const EdaDataFile_NetRecord_ToeprintSubnetRecord&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:odbdesign.proto.EdaDataFile.NetRecord.ToeprintSubnetRecord)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void EdaDataFile_NetRecord_ToeprintSubnetRecord::CopyFrom(const EdaDataFile_NetRecord_ToeprintSubnetRecord& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:odbdesign.proto.EdaDataFile.NetRecord.ToeprintSubnetRecord)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool EdaDataFile_NetRecord_ToeprintSubnetRecord::IsInitialized() const {
  return true;
}

void EdaDataFile_NetRecord_ToeprintSubnetRecord::InternalSwap(EdaDataFile_NetRecord_ToeprintSubnetRecord* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
...
class EdaDataFile_NetRecord_PlaneSubnetRecord::_Internal {
 public:
  using HasBits = decltype(std::declval<EdaDataFile_NetRecord_PlaneSubnetRecord>()._impl_._has_bits_);
...
EdaDataFile_NetRecord_PlaneSubnetRecord::EdaDataFile_NetRecord_PlaneSubnetRecord(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:odbdesign.proto.EdaDataFile.NetRecord.PlaneSubnetRecord)
}
EdaDataFile_NetRecord_PlaneSubnetRecord::EdaDataFile_NetRecord_PlaneSubnetRecord(const EdaDataFile_NetRecord_PlaneSubnetRecord& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  EdaDataFile_NetRecord_PlaneSubnetRecord* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
  ...
  ::memcpy(&_impl_.filltype_, &from._impl_.filltype_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.fillsize_) -
    reinterpret_cast<char*>(&_impl_.filltype_)) + sizeof(_impl_.fillsize_));
  // @@protoc_insertion_point(copy_constructor:odbdesign.proto.EdaDataFile.NetRecord.PlaneSubnetRecord)
}

inline void EdaDataFile_NetRecord_PlaneSubnetRecord::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
EdaDataFile_NetRecord_PlaneSubnetRecord::~EdaDataFile_NetRecord_PlaneSubnetRecord() {
  // @@protoc_insertion_point(destructor:odbdesign.proto.EdaDataFile.NetRecord.PlaneSubnetRecord)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void EdaDataFile_NetRecord_PlaneSubnetRecord::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void EdaDataFile_NetRecord_PlaneSubnetRecord::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void EdaDataFile_NetRecord_PlaneSubnetRecord::Clear() {
// @@protoc_insertion_point(message_clear_start:odbdesign.proto.EdaDataFile.NetRecord.PlaneSubnetRecord)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000007u) {
    ::memset(&_impl_.filltype_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.fillsize_) -
        reinterpret_cast<char*>(&_impl_.filltype_)) + sizeof(_impl_.fillsize_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
...
const char* EdaDataFile_NetRecord_PlaneSubnetRecord::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
...
uint8_t* EdaDataFile_NetRecord_PlaneSubnetRecord::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:odbdesign.proto.EdaDataFile.NetRecord.PlaneSubnetRecord)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:odbdesign.proto.EdaDataFile.NetRecord.PlaneSubnetRecord)
  return target;
}

size_t EdaDataFile_NetRecord_PlaneSubnetRecord::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:odbdesign.proto.EdaDataFile.NetRecord.PlaneSubnetRecord)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData EdaDataFile_NetRecord_PlaneSubnetRecord::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    EdaDataFile_NetRecord_PlaneSubnetRecord::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*EdaDataFile_NetRecord_PlaneSubnetRecord::GetClassData() const { return &_class_data_; }


void EdaDataFile_NetRecord_PlaneSubnetRecord::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<EdaDataFile_NetRecord_PlaneSubnetRecord*>(&to_msg);
  auto& from = static_cast<const EdaDataFile_NetRecord_PlaneSubnetRecord&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:odbdesign.proto.EdaDataFile.NetRecord.PlaneSubnetRecord)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void EdaDataFile_NetRecord_PlaneSubnetRecord::CopyFrom(const EdaDataFile_NetRecord_PlaneSubnetRecord& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:odbdesign.proto.EdaDataFile.NetRecord.PlaneSubnetRecord)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool EdaDataFile_NetRecord_PlaneSubnetRecord::IsInitialized() const {
  return true;
}

void EdaDataFile_NetRecord_PlaneSubnetRecord::InternalSwap(EdaDataFile_NetRecord_PlaneSubnetRecord* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(EdaDataFile_NetRecord_PlaneSubnetRecord, _impl_.fillsize_)
      + sizeof(EdaDataFile_NetRecord_PlaneSubnetRecord::_impl_.fillsize_)
      - PROTOBUF_FIELD_OFFSET(EdaDataFile_NetRecord_PlaneSubnetRecord, _impl_.filltype_)>(
          reinterpret_cast<char*>(&_impl_.filltype_),
          reinterpret_cast<char*>(&other->_impl_.filltype_));
}

::PROTOBUF_NAMESPACE_ID::Metadata EdaDataFile_NetRecord_PlaneSubnetRecord::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_edadatafile_2eproto_getter, &descriptor_table_edadatafile_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::odbdesign::proto::EdaDataFile_NetRecord_ToeprintSubnetRecord*
Arena::CreateMaybeMessage< ::odbdesign::proto::EdaDataFile_NetRecord_ToeprintSubnetRecord >(Arena* arena) {
  return Arena::CreateMessageInternal< ::odbdesign::proto::EdaDataFile_NetRecord_ToeprintSubnetRecord >(arena);
}
template<> PROTOBUF_NOINLINE ::odbdesign::proto::EdaDataFile_NetRecord_PlaneSubnetRecord*
Arena::CreateMaybeMessage< ::odbdesign::proto::EdaDataFile_NetRecord_PlaneSubnetRecord >(Arena* arena) {
  return Arena::CreateMessageInternal< ::odbdesign::proto::EdaDataFile_NetRecord_PlaneSubnetRecord >(arena);
}
